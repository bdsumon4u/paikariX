...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('brands')->update(['source_id' => DB::raw('id')]);
        ...
        DB::table('categories')->update(['source_id' => DB::raw('id')]);
        ...
        DB::table('attributes')->update(['source_id' => DB::raw('id')]);
        ...
        DB::table('options')->update(['source_id' => DB::raw('id')]);
        ...
        if (! Schema::hasColumn('products', 'source_id')) {
            ...
            DB::table('products')->update(['source_id' => DB::raw('id')]);
        }
    }
